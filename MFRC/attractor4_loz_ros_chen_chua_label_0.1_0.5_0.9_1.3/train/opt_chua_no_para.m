...
lb = [0 0 0 10^-10 0];
ub = [3 3 1 10^-2  1];
[train_data,testdata,data_num,data_len]= func_dataset_chua_no_para();
...
min_rmse = @(x) (func_train_repeat_chua_no_para(x,repeat_num,train_data,testdata,data_num,data_len));
